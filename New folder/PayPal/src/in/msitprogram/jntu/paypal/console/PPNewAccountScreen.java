...
public class PPNewAccountScreen {
	...
	public PPNewAccountScreen(String email, String password, String name, String phonenum, String address,String code) {
		profile = new Profile(email, password, name, phonenum, address, code);
